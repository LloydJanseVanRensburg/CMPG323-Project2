...
var AuthMiddleware = /** @class */ (function () {
    ...
    AuthMiddleware.auth = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var token, decoded, query, result, user, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        query = new node_1.default.Query(node_1.default.Session);
                        query.equalTo('sessionToken', decoded.sessionToken);
                        return [4 /*yield*/, query.first({ useMasterKey: true })];
                    case 2:
                        result = _a.sent();
                        if (!result) {
                            return [2 /*return*/, next(new BaseException_1.BaseException('No session found please login again', 404))];
                        }
